...
Remove-Item .\ShellStats-Standard-Overs-Fixtures.csv -Force -ErrorAction:SilentlyContinue
Remove-Item .\ShellStats-Standard-Overs-AllTeams.csv -Force -ErrorAction:SilentlyContinue
...
foreach ($league in $leagues)
{
  ...
  foreach ($uniqueTeam in $uniqueTeams)
  {
    ...
    $line
    $line | Out-File .\ShellStats-Standard-AllTeams.csv -Append -Encoding utf8
  } 
}
}
...
foreach ($fixture in $fixtures)
{
  ...
  $line | Out-File .\ShellStats-Standard-Fixtures.csv -Append -Encoding utf8

...
Remove-Item .\ShellStats-BTTS-Fixtures.csv -Force -ErrorAction:SilentlyContinue
Remove-Item .\ShellStats-BTTS-AllTeams.csv -Force -ErrorAction:SilentlyContinue
...
foreach ($league in $leagues)
{
  ...
  foreach ($uniqueTeam in $uniqueTeams)
  {
    ...
    $line
    $line | Out-File .\ShellStats-BTTS-AllTeams.csv -Append -Encoding utf8
  } 
}
...
foreach ($fixture in $fixtures)
{
  ...
  $line | Out-File .\ShellStats-BTTS-Fixtures.csv -Append -Encoding utf8
